...
enum {
  ...
  BRIDGE_WORKSPACETYPE_INPUT_SOURCE_DETAIL_ID,
...
enum {
  ...
  BRIDGE_USERCLIENT_TYPE_SET_WORKSPACEDATA_APP_IDS,
  BRIDGE_USERCLIENT_TYPE_SET_WORKSPACEDATA_INPUT_SOURCE_IDS,
  BRIDGE_USERCLIENT_TYPE_SET_WORKSPACEDATA_INPUT_SOURCE_DETAILI_DS,
  BRIDGE_USERCLIENT_TYPE_SET_WORKSPACEDATA_UI_ELEMENT_ROLE_ID,
  BRIDGE_USERCLIENT_TYPE_SET_WORKSPACEDATA_WINDOW_NAME_IDS,
