...
private:
  ...
  struct HookedKeyboard {
    ...
    void setExtraRepeatInfo(org_pqrs_KeyRemap4MacBook::ExtraRepeatFunc::ExtraRepeatFunc func, unsigned int flags, unsigned int keyboardType, AbsoluteTime ts, OSObject *target, void *refcon);
  };
