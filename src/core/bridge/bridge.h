...
enum {
  ...
  BRIDGE_FILTERTYPE_CONFIG_NOT,  // XXX: remove me
  BRIDGE_FILTERTYPE_CONFIG_ONLY, // XXX: remove me
  ...
  BRIDGE_FILTERTYPE_KEYBOARDTYPE_NOT,
  BRIDGE_FILTERTYPE_KEYBOARDTYPE_ONLY,
};
