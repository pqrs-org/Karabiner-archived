...
namespace org_pqrs_KeyRemap4MacBook {
  ...
  SYSCTL_INT(_keyremap4macbook_remap, OID_AUTO, commandL2shiftL, CTLTYPE_INT|CTLFLAG_RW,
             &(config.remap_commandL2shiftL), 0, "");

  SYSCTL_INT(_keyremap4macbook_remap, OID_AUTO, commandL2backquote, CTLTYPE_INT|CTLFLAG_RW,
             &(config.remap_commandL2backquote), 0, "");

  // ----------------------------------------
  SYSCTL_INT(_keyremap4macbook_remap, OID_AUTO, commandR2controlL, CTLTYPE_INT|CTLFLAG_RW,
             &(config.remap_commandR2controlL), 0, "");

  SYSCTL_INT(_keyremap4macbook_remap, OID_AUTO, commandR2optionL, CTLTYPE_INT|CTLFLAG_RW,
             &(config.remap_commandR2optionL), 0, "");

  SYSCTL_INT(_keyremap4macbook_remap, OID_AUTO, commandR2shiftL, CTLTYPE_INT|CTLFLAG_RW,
             &(config.remap_commandR2shiftL), 0, "");
  ...
  SYSCTL_INT(_keyremap4macbook_remap, OID_AUTO, enter2optionL_commandSpace, CTLTYPE_INT|CTLFLAG_RW,
             &(config.remap_enter2optionL_commandSpace), 0, "");
  ...
  SYSCTL_INT(_keyremap4macbook_remap, OID_AUTO, enter2commandLshiftL, CTLTYPE_INT|CTLFLAG_RW,
             &(config.remap_enter2commandLshiftL), 0, "");
  ...
  // ----------------------------------------
  SYSCTL_INT(_keyremap4macbook_remap, OID_AUTO, shiftR2commandL, CTLTYPE_INT|CTLFLAG_RW,
             &(config.remap_shiftR2commandL), 0, "");

  SYSCTL_INT(_keyremap4macbook_remap, OID_AUTO, shiftR2controlL, CTLTYPE_INT|CTLFLAG_RW,
             &(config.remap_shiftR2controlL), 0, "");

  SYSCTL_INT(_keyremap4macbook_remap, OID_AUTO, shiftR2fn, CTLTYPE_INT|CTLFLAG_RW,
             &(config.remap_shiftR2fn), 0, "");

  SYSCTL_INT(_keyremap4macbook_remap, OID_AUTO, shiftR2optionL, CTLTYPE_INT|CTLFLAG_RW,
             &(config.remap_shiftR2optionL), 0, "");
  ...
  // ----------------------------------------
  SYSCTL_INT(_keyremap4macbook_remap, OID_AUTO, tab2f9, CTLTYPE_INT|CTLFLAG_RW,
             &(config.remap_tab2f9), 0, "");
  ...
  SYSCTL_INT(_keyremap4macbook_remap, OID_AUTO, jis_eisuu2escape, CTLTYPE_INT|CTLFLAG_RW,
             &(config.remap_jis_eisuu2escape), 0, "");
  ...
  SYSCTL_INT(_keyremap4macbook_remap, OID_AUTO, jis_unify_kana_to_eisuu, CTLTYPE_INT|CTLFLAG_RW,
             &(config.remap_jis_unify_kana_to_eisuu), 0, "");
  ...
  SYSCTL_INT(_keyremap4macbook_remap, OID_AUTO, jis_command_twice_to_kana_twice, CTLTYPE_INT|CTLFLAG_RW,
             &(config.remap_jis_command_twice_to_kana_twice), 0, "");

  SYSCTL_INT(_keyremap4macbook_remap, OID_AUTO, jis_commandR2commandR_kana, CTLTYPE_INT|CTLFLAG_RW,
             &(config.remap_jis_commandR2commandR_kana), 0, "");

  SYSCTL_INT(_keyremap4macbook_remap, OID_AUTO, jis_commandL2controlL_eisuu, CTLTYPE_INT|CTLFLAG_RW,
             &(config.remap_jis_commandL2controlL_eisuu), 0, "");
